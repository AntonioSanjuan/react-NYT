        ...
        <>
            <div className='CV_MainContainer'>
                ...
                <div className='CV_WorkExperiences' ref={workExperienceRef}>
                    ...
                    <div className='CV_WorkExperience'>
                        <div className='CV_WorkExperiences_Time'>
                            <p className="app_font_m app_font_noMargin"> <b>01/03/2021</b> - <b>CURRENT</b> - Remote, Spain </p>
                        </div>
                    ...
                    <div className='CV_WorkExperience'>
                        <div className='CV_WorkExperiences_Time'>
                            <p className="app_font_m app_font_noMargin"> <b>01/09/2018</b> - <b>01/03/2021</b> - San Cristobal de La Laguna, Spain </p>
                        </div>
                        <div className='CV_WorkExperiences_Company'>
                ...
                <div className="CV_Summary">
                        <div className='CV_SummaryEle' onClick={() => scroolTo(aboutMeRef)}>About Me</div>
                        <div className='CV_SummaryEle' onClick={() => scroolTo(workExperienceRef)}>Work Experience</div>
                        <div className='CV_SummaryEle' onClick={() => scroolTo(educationRef)}>Education</div>
                        <div className='CV_SummaryEle' onClick={() => scroolTo(skillsRef)}>Skills</div>
                </div>
            </div>
        </>
    );
